        ...
        >
          ...
          <div className="flex min-h-11 flex-wrap items-center justify-between gap-1.5 px-3 py-2">
            <div className="flex min-w-0 flex-wrap items-center gap-1.5">
              ...
              <span
                className="inline-flex h-8 max-w-full items-center gap-1.5 rounded-full border border-foreground/10 bg-foreground/[0.025] px-2.5 text-[11px] font-medium text-foreground/60"
                title={modelParametersLabel}
              >
                <IconSliders className="size-3 shrink-0" />
